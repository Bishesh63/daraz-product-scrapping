    ...
    def category_name(self):
        with sync_playwright() as p:
            ...
            try:
                ...
                self.page.wait_for_selector(self.query_name_selector, timeout=100000)
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    self.page.wait_for_selector(self.name_selector, timeout=1*100000)
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    self.page.wait_for_selector(self.price_selector, timeout=1*100000)
