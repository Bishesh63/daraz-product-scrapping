...
main_url = """https://www.daraz.com.np/catalog/?q=hair+cream&_keyori=ss&from=input&spm=a2a0e.searchlist.search.go.37762a47Ww6RgR"""
...
# Sender address:
EMAIL_ADDRESS = os.environ.get("bishesh63@gmail.com")
EMAIL_PASSWORD = os.environ.get("Helloits63#123@")
RECEIVERS = "bisheshmansingh@gmail.com"  # Paste the email address here
SUBJECT = "ALERT EMAIL!!!!!!"
CONTENT = f"Hello Bishesh! {folder_name} database is saved."
